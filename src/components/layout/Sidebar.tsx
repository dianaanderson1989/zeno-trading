  ...
  return (
    <aside className="w-[220px] flex-shrink-0 flex flex-col min-h-screen border-r border-white/[0.05]"
          ...
          <NavLink key={to} to={to}
            className={({ isActive }) =>
              `group flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm font-medium transition-all duration-150 border ${
                isActive ? 'text-neon-green bg-neon-green/10 border-neon-green/20' : 'text-slate-400 hover:text-white hover:bg-white/[0.04] border-transparent'
              }`
            }>
            {({ isActive }) => (
              <>
            ...
            <NavLink to="/admin"
              className={({ isActive }) =>
                `group flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm font-medium transition-all border ${
                  isActive ? 'text-neon-cyan bg-neon-cyan/10 border-neon-cyan/20' : 'text-slate-400 hover:text-white hover:bg-white/[0.04] border-transparent'
                }`
              }>
      ...
      <div className="p-3 border-t border-white/[0.05]">
        <NavLink to="/account"
          className={({ isActive }) =>
            `flex items-center gap-3 px-3 py-2.5 rounded-xl transition-all ${isActive ? 'bg-white/[0.06]' : 'hover:bg-white/[0.04]'}`
          }>
